...
class FaceRecognition:
    ...
    def faceDetect(self, Entry1):
        ...
        while(True):
            ...
            for (x, y, w, h) in faces:
                ...
                cv2.imwrite(str(BASE_DIR)+f'/sugartownapp/dataset/User.' +
    ...
    def trainFace(self):
        ...
        path = str(BASE_DIR)+'/sugartownapp/dataset'
        ...
        recognizer.save(str(BASE_DIR)+'/sugartownapp/trainer/trainer.yml')
